...
<html>
<head>
	<title><?php echo displayText('1-B', 'utf8', 0, 1); # Sales Price List ?> v3.0</title>
...
<body id="loading" class=''>
	...
	<?php
				...
				{
					echo "<span style = 'color:red;font-size:15px;'>Sorry, your file was not uploaded!</span>";
				}
				if(isset($_GET['error']) AND $_GET['error'] == 2)
				{
					echo "<span style = 'color:red;font-size:15px;'>Sorry, there was an error uploading your file!</span>";
				}
	?>
        <div class="w3-padding-top"></div>
        <div class="row w3-padding-top">
			<div class="col-lg-7 col-md-7 col-sm-12 col-xs-12">
				<a href='/<?php echo v; ?>/1-B Price List V2/V3.0/raymond_salesPriceList.php'><button class="w3-btn w3-round w3-pink"><i class='fa fa-send'></i>&emsp;<b><?php echo (displayText('1', 'utf8', 0, 1, 1));?></b></button></a>
				<a href='/<?php echo v; ?>/4-D Purchasing Price List/gerald_priceV2.php'><button class="w3-btn w3-round w3-blue"><i class='fa fa-send'></i>&emsp;<b><?php echo (displayText('4', 'utf8', 0, 1, 1));?></b></button></a>
            </div>
			...
			<div class="col-lg-5 col-md-5 col-sm-12 col-xs-12">
                <div class='w3-right'>
                    <button class="w3-btn w3-round w3-blue" id='addData'><i class='fa fa-plus'></i>&emsp;<b><?php echo (displayText('B4', 'utf8', 0, 0, 1));?></b></button>
                    <button class="w3-btn w3-round w3-blue" id='addData2'><i class='fa fa-plus'></i>&emsp;<b><?php echo (displayText('L3669', 'utf8', 0, 0, 1))." ".(displayText('L267', 'utf8', 0, 0, 1));?></b></button>
                    <button class="w3-btn w3-round w3-pink" id='filterData'><i class='fa fa-list'></i>&emsp;<b><?php echo (displayText('B7', 'utf8', 0, 0, 1));?></b></button>
...
$(document).ready(function(){
    ...
    var dataTable = $('#mainTableId').DataTable( {
        ...
        "bInfo" 		: false,
        "ajax":{
            url     :"jhon_salesPriceListAJAX.php", // json datasource
    ...
    $("#addData2").click(function(){
        $("#modal-izi").iziModal({
            title 					: '<i class="fa fa-plus w3-large"></i>&emsp;<label class="w3-large">IMPORT PRICE</label>',
            headerColor 			: '#1F4788',
            subtitle 				: '',
            width 					: 400,
            fullscreen 				: false,
            ...
            onOpening   			: function(modal){
                                        modal.startLoading();
                                        setTimeout(function(){
                                            $.post( "../../2-7 Request For Quotation List/RFQ Import/rose_uploadExcel.php?modalBoxType=3", function( data ) {
                                                $( ".izimodal-content" ).html(data);
                                                modal.stopLoading();
                                            });
                                        }, 100);
    ...
    $("#filterData").click(function(){
        ...
        $("#modal-izi").iziModal({
            title                   : '<i class="fa fa-flash"></i> <?php echo (displayText("B7", "utf8", 0, 1, 1)); ?>',
            headerColor             : '#1F4788',
